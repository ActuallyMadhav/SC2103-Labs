...
HD_PWD='C:/Users/madhav010/Desktop/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_imp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_imp.tcl
