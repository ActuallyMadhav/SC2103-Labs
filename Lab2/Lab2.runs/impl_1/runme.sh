...
HD_PWD='C:/Users/madhav010/Desktop/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_imp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_imp.tcl -notrace
